...
// Parse the query string and extract the 'editProduct' parameter
const urlParams = new URLSearchParams(queryString);
const editProduct = urlParams.get('editProduct');

// Use the 'editProduct' variable to find the product
let getProduct = products.find((i) => i.id === editProduct);
